...
<div id="formLayer" style="left: 0px; overflow: visible; position: relative; top: 0px; width: 100%; height: 100%;">
  <table width="740" height="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="Page">
    ...
    <font size="5" color="#84B6CE"><b>Solutions</b></font><hr>
    <table width="690" border="1" cellpadding="8" cellspacing="0" bordercolor="#C0C0C0">
      <tbody><tr align="center" valign="top"> 
        <td width="690"> <font size="2" color="#426984"><b>Your own YouSendIt</b></font>
          <p align="center"><strong>Now you can easily create your own file sharing service!</strong></p>
          <p>Just use the source code and upload it to your server:</p>
          <p><b><a href="https://github.com/tankwars92/YouSendIt">Download source code
            now</a> »</b></p> </td>
      </tr>
    </tbody></table>
